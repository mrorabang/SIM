...
const HomeExcel = () => {
  ...
  const parseInput = () => {
    ...
    console.log(matches); // Xem matches có những gì
    ...
    const result = matches.map((match) => {
      ...
      const price = match[2];
      console.log(productName, price); // Xem giá trị của productName và price
  ...
  return (
    <div className="App">
      <div className="header">
        <h1>SIM KHÔNG GÓP FILE EXCEL</h1>
      </div>
